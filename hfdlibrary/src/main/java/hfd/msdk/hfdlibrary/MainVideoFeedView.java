 ...
 */
public class MainVideoFeedView extends TextureView implements SurfaceTextureListener {
    //region Properties
    ...
    //region Life-Cycle
    public MainVideoFeedView(Context context) {
        this(context, null, 0);
    }

    public MainVideoFeedView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MainVideoFeedView(Context context, AttributeSet attrs, int defStyle) {
